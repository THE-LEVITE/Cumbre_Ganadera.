...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="tablaInsumo" runat="server" visible="false">
        <div class="counter-card">
            ...
            <span class="counter-number">
                <asp:Label ID="lblNumeroInsumos" runat="server" Text="0"></asp:Label></span>
        </div>
    ...
    <div id="tablaHerramienta" runat="server" visible="false">
        <div class="counter-card">
            ...
            <span class="counter-number">
                <asp:Label ID="lblNumeroHerramientas" runat="server" Text="0"></asp:Label></span>
        </div>
    ...
    <div id="tablaMaquinaria" runat="server" visible="false">
        <div class="counter-card">
            ...
            <span class="counter-number">
                <asp:Label ID="lblNumeroMaquinaria" runat="server" Text="0"></asp:Label></span>
        </div>
