<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Estructura.Master" AutoEventWireup="true" CodeBehind="ResumenHacienda.aspx.cs" Inherits="CumbreGanadera.Vista.Dueño.MisHaciendas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:Button ID="btntVerHacienda" runat="server" CssClass="btn btn-success" Text="Registrar Gerente" OnClick="btntVerHacienda_Click" />
    </div>
