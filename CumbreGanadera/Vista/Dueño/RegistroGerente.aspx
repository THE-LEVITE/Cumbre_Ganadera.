...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col mt-4">
                    ...
                    <asp:DropDownList class="form-control fondotxt" ID="dlDepartamento" ForeColor="White" BackColor="#2f4029" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dlCiudad_SelectedIndexChanged"></asp:DropDownList>
                </div>
                <div class="col mt-4">
    ...
    <div class="row">
        <div class="col mt-4 margenBotones">
            <asp:Button runat="server" Text="Completar registro" CssClass="btn w-100 boronesCrudRegistrar" OnClick="btnRegistrar_Click" />
        </div>
        <div class="col mt-4 margenBotones">
            <asp:Button runat="server" Text="Cancelar" CssClass="btn w-100 boronesCrudCancelar" OnClick="btnCancelar_Click" />
