        ...
        <div class="CardRegistro">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-icon mb-3">
                        <asp:DropDownList CssClass="form-control fondotxt" ID="dlDepartamento" AutoPostBack="true" BackColor="#2f4029" ForeColor="White" runat="server" OnSelectedIndexChanged="dlDepartamento_SelectedIndexChanged"></asp:DropDownList>
                    </div>
                </div>
