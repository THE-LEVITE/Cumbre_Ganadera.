<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="CumbreGanadera.Index" %>
...
<body class="font-body-md text-body-md overflow-x-hidden">
    ...
    <header class="sticky top-0 w-full z-50 bg-background/90 backdrop-blur-xl border-b border-primary/10">
        <div class="max-w-container-max mx-auto px-margin py-4 flex justify-between items-center">
            ...
            <div class="flex items-center gap-stack-md">
                ...
                <button class="font-label-md text-label-md text-on-surface hover:text-primary transition-all" onclick="window.location.href='Vista/Auth/InicioSesion.aspx'; return false;">Login</button>
                <button class="bg-primary-container text-on-primary-container px-6 py-2 rounded-lg font-label-md text-label-md hover:bg-primary transition-all" href="RegistroCliente.aspx">
                    Registrarse
                </button>
            </div>
        </div>
    ...
    <main class="min-h-screen">
        ...
        <section class="relative w-full h-[65vh] flex flex-col items-center justify-center text-center overflow-hidden">
