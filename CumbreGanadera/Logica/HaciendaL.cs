...
namespace CumbreGanadera.Logica
{
    public class HaciendaL
    {
        ...
        public List<Hacienda> MTListarTodasLasHaciendas()
        {
            List<Hacienda> listaHaciendas = oDatosHacienda.MTListarTodasHaciendas();
            return listaHaciendas;
        }
        public List<Hacienda> MTDueñoHacienda(int idDueño)
        {
            List<Hacienda> listaHaciendas = oDatosHacienda.MTDueñoHacienda(idDueño);
            return listaHaciendas;
        }
